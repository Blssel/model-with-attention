...
'''
注：本段代码来自github：https://github.com/LittleHeap/Tensorflow-in-Action
...
if __name__=='__main__':
	...
	num_classes=101
	min_after_dequeue=53
	inputs,groundtruth=assist.next_batch.next_batch(batch_size, data_path, frames_needed,frame_gap,input_frame_size,num_classes,min_after_dequeue)
	print('#########')
	print(inputs.shape)
	print('########')
	logits,_=inception_v3(inputs, num_classes=101)

	#output,_=inception_v1_base(inputs, final_endpoint='Mixed_5c', scope='InceptionV1')
