...
if __name__=='__main__':
	batch_size=5
	data_path='/home/mcger/datasets/ucf101'
	frames_needed=1
	frame_gap=1
	input_frame_size=224
	num_classes=101

	inputs,_=next_batch.next_batch(batch_size, data_path, frames_needed,frame_gap,input_frame_size,num_classes)
	inputs=tf.squeeze(inputs)
	print('#########')
	print(inputs.shape)
	print('########')
	#logits,_=inception_v1(inputs, num_classes=101) 
